...
class JetIQSubjectManagerTest : JetIQNetworkManagerTest() {
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun test_getSuccessJournal_parses_json_rightfully() = runBlockingTest {
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun test_getSubjectDetails_parses_json_rightfully() = runBlockingTest {
    ...
    @ExperimentalCoroutinesApi
    @Test
    fun test_getMarkbookSubjects_parses_json_rightfully() = runBlockingTest {
