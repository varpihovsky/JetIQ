 ...
 * @param policy
 */
fun <T> loggedStack(policy: LogPolicy = LogPolicy.INFO): Stack<T> =
    LoggedStack(policy, stack())

private class LoggedStack<T>(override val policy: LogPolicy, private val deque: Stack<T>) :
    Stack<T> by deque, Logged {
