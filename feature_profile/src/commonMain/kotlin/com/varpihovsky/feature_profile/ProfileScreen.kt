...
const val MULTIPANE_WIDTH_THRESHOLD = 800
const val SINGLE_PANE_WEIGHT = 1f
const val PROFILE_PANE_WEIGHT = 0.75f
const val DETAILS_PANE_WEIGHT = 0.25f

@Composable
fun ProfileScreen(profileRootComponent: ProfileRootComponent, paddingValues: PaddingValues) {
        ...
        Row(modifier = Modifier.fillMaxSize()) {
            Box(
                ...
                if (isMultiPane || !isRouterShown(routerState)) {
                    Profile(profileRootComponent.profileComponent, paddingValues)
                }
            }
